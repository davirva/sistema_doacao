 ...
 * Usuarios Model
 *
 * @property \App\Model\Table\TipoUsuariosTable&\Cake\ORM\Association\BelongsTo $TipoUsuarios
...
class UsuariosTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn('tipo_usuario_id', 'TipoUsuarios'), ['errorField' => 'tipo_usuario_id']);
